...
var _shadowSelectionPolyfill = __webpack_require__(39);
...
var supportsDescriptors = __webpack_require__(20).supportsDescriptors;
var gOPD = Object.getOwnPropertyDescriptor;
var TypeErr = TypeError;
...
module.exports = {
  'align': {
    ...
    'justify': __webpack_require__(93)
  },
  'background': __webpack_require__(94),
  'blockquote': __webpack_require__(95),
  'bold': __webpack_require__(96),
  'clean': __webpack_require__(97),
  'code': __webpack_require__(72),
  'code-block': __webpack_require__(72),
  'color': __webpack_require__(98),
  'direction': {
    '': __webpack_require__(99),
    'rtl': __webpack_require__(100)
  },
  'float': {
    'center': __webpack_require__(101),
    'full': __webpack_require__(102),
    'left': __webpack_require__(103),
    'right': __webpack_require__(104)
  },
  'formula': __webpack_require__(105),
  'header': {
    '1': __webpack_require__(106),
    '2': __webpack_require__(107)
  },
  'italic': __webpack_require__(108),
  ...
  'list': {
    'ordered': __webpack_require__(113),
    'bullet': __webpack_require__(114),
    'check': __webpack_require__(115)
  },
  'script': {
    'sub': __webpack_require__(116),
    'super': __webpack_require__(117)
  },
  'strike': __webpack_require__(118),
  'underline': __webpack_require__(119),
  'video': __webpack_require__(120)
};
...
var _iconPicker = __webpack_require__(74);
...
var _formula = __webpack_require__(88);

var _formula2 = _interopRequireDefault(_formula);

var _syntax = __webpack_require__(89);
...
var _bubble = __webpack_require__(122);

var _bubble2 = _interopRequireDefault(_bubble);

var _snow = __webpack_require__(76);
...
var _quill = __webpack_require__(77);
...
describe('Selection', function () {
  ...
  describe('shadow root', function () {
    ...
    it('getRange()', function () {
      var selection = this.initialize(_selection2.default, '<p>0123</p>', container);
    ...
    it('setRange()', function () {
      var selection = this.initialize(_selection2.default, '', container);
  ...
  describe('setRange()', function () {
    ...
    it('null', function () {
      ...
      var _selection$getRange37 = selection.getRange(),
          _selection$getRange38 = _slicedToArray(_selection$getRange37, 1),
          range = _selection$getRange38[0];

      expect(range).not.toEqual(null);
      selection.setRange(null);

      var _selection$getRange39 = selection.getRange();

      var _selection$getRange40 = _slicedToArray(_selection$getRange39, 1);

      range = _selection$getRange40[0];
...
describe('Toolbar', function () {
  ...
  describe('shadow dom', function () {
    ...
    beforeEach(function () {
      ...
      editor = new _quill2.default(container.shadowRoot.querySelector('.editor'), {
        modules: {
          toolbar: '.toolbar'
        }
      });
    ...
    it('should initialise', function () {
      var editorDiv = container.shadowRoot.querySelector('.editor');
      var toolbarDiv = container.shadowRoot.querySelector('.toolbar');
